namespace GSGD1
{
	...
	public class WaveDatabase : ScriptableObject
	{
		...
		[SerializeField]
		private List<WaveSet> _waveSets = null;

		public List<WaveSet> WaveSets
		{
			get { return _waveSets; }
		}
	...
	public class WaveEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.TextArea(string.Format("Total Duration : {0} seconds", GetWaveDuration(waveDatabase.WaveSets).ToString()));
		}
